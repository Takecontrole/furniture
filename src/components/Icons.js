...
<svg viewBox="3 15 45 10" id="svg1" xmlns="http://www.w3.org/2000/svg"  height="100%" width="100%" >

<path fill="none"  stroke="black" stroke-dasharray="170" stroke-dashoffset="0" d="M10 40V24H4L24 6l10 8.85V9h4v9.55L44 24h-6v16H26.5V28h-5v12Zm3-3h5.5V25h11v12H35V19.95l-11-10-11 10Zm5.5-12h11-11Zm1.25-5.5h8.5q0-1.65-1.275-2.725Q25.7 15.7 24 15.7q-1.7 0-2.975 1.075Q19.75 17.85 19.75 19.5Z">
<animate attributeName="stroke-dashoffset"  values="170; 0" dur="3s" repeatCount="indefinite" calcMode="linear"></animate>
</path>
</svg>
</div>
...
<p>Высокоточное изготовление</p>
 ...
 <div class="textcontainer">
 <div className="symbols">
<svg fill="gray" stroke="#274060" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/1999/xlink" 
	 width="100%" height="100%" viewBox="-2 15 70 10"
	 >
<g>
	<g>
		<path stroke-dasharray="320" stroke-dashoffset="0" d="M59.583,49.727c-0.447-1.121-1.344-1.346-2.463-1.793c-5.152-2.016-9.408-2.688-14.336-4.479
			...
			<animate attributeName="stroke-dashoffset"  values="320; 0" dur="3s" repeatCount="indefinite" calcMode="linear"></animate>
			</path>
	</g>
</g>
</svg>
