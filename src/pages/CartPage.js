...
const stripePromise = loadStripe("pk_test_51MHQtBHmbksrsN9ww1whQNFjeaBWyq1FgINbarQyVHp6N4aK1aXedMtbk5jTKAiSZYCgzlYBLhm37MPBmQp9vv1I00TWPVEQpu");
...
function CartPage() {
    ...
    function handleDecrease(product) {
        ...
        if (quantity <= 0) return alert("Невозможно");
                ...
                {cart.length > 0 && (
                    <Col md={5}>
                        <>
                            ...
                            <div>
                                <h3 className="h4 pt-4">Итог: {user.cart.total}</h3>
                            </div>
                        </>
                    </Col>
                )}
