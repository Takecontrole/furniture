                    ...
                    <Form style={{ width: "100%" }} onSubmit={handleSubmit}>
                        ...
                        <Form.Group className="mb-3" onChange={(e) => setCategory(e.target.value)}>
                            ...
                            <Form.Select value={category}>
                                ...
                                <option value="роскошный лаундж">роскошный лаундж</option>
                                <option value="уютный текстиль">уютный текстиль</option>
                                <option value="костровые ямы">костровые ямы</option>
                                <option value="еда на свежем воздухе">еда на свежем воздухе</option>
                                <option value="кресла для гостинной">кресла для гостинной</option>
