            ...
            <Video2 />
             ...
             <div className="category-container">
              ...
              <div style={{width:"100%"}}>
                ...
                <h2 style={{marginTop:"30px",}} >Наши рекомендации по выбору мебели.</h2>
                <h2 style={{marginTop:"40px"}}>1.Разработайте стиль</h2>
                ...
                <h2 style={{marginTop:"40px"}}>2. Выберите ткань.</h2>
                ...
                <h2 style={{marginTop:"40px"}}>3.Выберите отделку </h2>
